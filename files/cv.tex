...
\begin{itemize}
\item Incentive separability (with P. Dworczak, J. Krysta and F. Tokarski), 2023
...
\begin{itemize}
  \item 2023: Summer Workshop on Macro \& Finance (Warsaw), SAET Annual Conference, CERGE-EI Workshop on Economic Theory (planned), Ludwig Maximilian University of Munich (planned), SEA Annual Meeting (planned)
