...
\begin{itemize}
\item Redistribution with Performance Pay (with A. Ndiaye and N. Werquin), 2022, resubmitted \textit{Journal of Political Economy}
\item Optimal Redistribution with a Shadow Economy (with Luis E. Rojas), 2022, accepted with minor revisions in \textit{Theoretical Economics}
